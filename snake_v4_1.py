...
import snake_v4_1_tools    # noqa F401 - required for debugging
from snake_v4_1_tools import (BLACK, Setup, init_cells, plot_window,
                              plot_monitor, plot_status, display_text)
import snake_v4_1_wall     # noqa F401 - required for debugging
from snake_v4_1_wall import init_walls, plotlist_walls

import snake_v4_1_control  # noqa F401 - required for debugging
from snake_v4_1_control import Control

import snake_v4_1_snake as sm
from snake_v4_1_snake import (move_randomly, show_snake_vision,
...
def main():
    ...
    '''
    global setup, cntrl, debug_stats, cell, wall, elapsed_time, plotlist
