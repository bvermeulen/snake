...
from snake_configuration import BLACK, WHITE, RED, GREY, YELLOW, BLUE, ORANGE, LWIDTH, read_config, SnakeSetup
...
class SnakeObject:
    ...
    def move(self):
        ...
        # and set new head to 'snake', unless this is a wall
        if cell[self.head[0]][self.head[1]].content != 'wall':
            cell[self.head[0]][self.head[1]].content = 'snake' # set cell at the head of the snake to 'snake'
