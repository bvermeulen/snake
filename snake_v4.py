...
import snake_module_v4
from snake_module_v4 import (SnakeObject, WallObject, Cell, plot_grid_walls, init_walls, init_cells, mouse_pressed, 
...
def main():
    ...
    '''
    global run, pause, Left, Right, m, wall, time, bcolor, setup, cell, snake, debug_stats # set to global to have access at interrupt
...
#           print(debug_stats)
    ...
    return run, pause, Left, Right, m, cell, wall, time, bcolor, setup, snake, debug_stats

if __name__ == '__main__':
    run, pause, Left, Right, m, cell, wall, time, bcolor, setup, snake, debug_stats = \
